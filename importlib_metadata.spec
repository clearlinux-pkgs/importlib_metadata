...
Source0  : https://files.pythonhosted.org/packages/48/18/08eaa583eb21602e86e32d534fa7f40159774566037e60a69822b10ef3ad/importlib_metadata-3.7.2.tar.gz
...
%prep
%setup -q -n importlib_metadata-3.7.2
cd %{_builddir}/importlib_metadata-3.7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615218000
...
cp %{_builddir}/importlib_metadata-3.7.2/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
