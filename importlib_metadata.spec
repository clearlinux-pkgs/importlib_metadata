...
Source0  : https://files.pythonhosted.org/packages/b4/1b/baab42e3cd64c9d5caac25a9d6c054f8324cdc38975a44d600569f1f7158/importlib_metadata-1.6.0.tar.gz
...
%prep
%setup -q -n importlib_metadata-1.6.0
cd %{_builddir}/importlib_metadata-1.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585315553
...
cp %{_builddir}/importlib_metadata-1.6.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
