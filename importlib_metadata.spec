...
Source0  : https://files.pythonhosted.org/packages/9b/42/86a31ce5fd7e3c5fc9071cec95d0aab11deb2fd63eed27315f520d120bfd/importlib_metadata-1.2.0.tar.gz
...
%prep
%setup -q -n importlib_metadata-1.2.0
cd %{_builddir}/importlib_metadata-1.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575560001
...
cp %{_builddir}/importlib_metadata-1.2.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
