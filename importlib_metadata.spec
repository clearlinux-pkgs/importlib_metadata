...
Source0  : https://files.pythonhosted.org/packages/8e/33/d54eacc679af34dc7c03fe9f3383669095b27fa17bd820cd33ec957cb249/importlib_metadata-3.10.0.tar.gz
...
%prep
%setup -q -n importlib_metadata-3.10.0
cd %{_builddir}/importlib_metadata-3.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617116370
...
cp %{_builddir}/importlib_metadata-3.10.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
