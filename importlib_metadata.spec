...
Source0  : https://files.pythonhosted.org/packages/99/23/aac25e607237feabe8d076932d27a590341001a9bf8a1e4149ee1c3c3c40/importlib_metadata-3.7.3.tar.gz
...
%prep
%setup -q -n importlib_metadata-3.7.3
cd %{_builddir}/importlib_metadata-3.7.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615753187
...
cp %{_builddir}/importlib_metadata-3.7.3/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
