...
Source0  : https://files.pythonhosted.org/packages/aa/9a/8483b77e2decd95963d7e34bc9bc91a26e71fd89b57d8cf978ca24747c7f/importlib_metadata-1.6.1.tar.gz
...
%prep
%setup -q -n importlib_metadata-1.6.1
cd %{_builddir}/importlib_metadata-1.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591395626
...
cp %{_builddir}/importlib_metadata-1.6.1/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
