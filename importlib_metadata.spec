...
Source0  : https://files.pythonhosted.org/packages/7d/d4/dbc58eed92be61bae65a7d80a7604d35bf6ded3e3c53c14f2d45b4a28831/importlib_metadata-3.1.0.tar.gz
...
%prep
%setup -q -n importlib_metadata-3.1.0
cd %{_builddir}/importlib_metadata-3.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606233617
...
cp %{_builddir}/importlib_metadata-3.1.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
