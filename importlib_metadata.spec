...
Version  : 3.9.1
Release  : 46
URL      : https://files.pythonhosted.org/packages/04/d5/791db32bcbe520dafbbc4120bc815f4015b7a1cb0386dd69d7ebf20cc07a/importlib_metadata-3.9.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/04/d5/791db32bcbe520dafbbc4120bc815f4015b7a1cb0386dd69d7ebf20cc07a/importlib_metadata-3.9.1.tar.gz
...
%prep
%setup -q -n importlib_metadata-3.9.1
cd %{_builddir}/importlib_metadata-3.9.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617028100
...
cp %{_builddir}/importlib_metadata-3.9.1/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
