...
Source0  : https://files.pythonhosted.org/packages/c7/7c/126a8686399ebe256b5e4343ea80b6f2ee91549969da2eef0bb2891b8d24/importlib_metadata-4.2.0.tar.gz
...
%prep
%setup -q -n importlib_metadata-4.2.0
cd %{_builddir}/importlib_metadata-4.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622064081
...
cp %{_builddir}/importlib_metadata-4.2.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
