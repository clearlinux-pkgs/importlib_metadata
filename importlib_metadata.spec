...
Source0  : https://files.pythonhosted.org/packages/cb/bb/7a935a48bf751af244090a7bd558769942cf13a7eba874b8b25538f3db01/importlib_metadata-1.3.0.tar.gz
...
%prep
%setup -q -n importlib_metadata-1.3.0
cd %{_builddir}/importlib_metadata-1.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576512052
...
cp %{_builddir}/importlib_metadata-1.3.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
