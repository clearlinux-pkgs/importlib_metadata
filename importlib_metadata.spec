...
Source0  : https://files.pythonhosted.org/packages/1c/7f/fe573d2225d7e0ea4bd9e8673b2c7fc0b2b2b2f86b36f8c5fe75b77e59c4/importlib_metadata-4.5.0.tar.gz
...
%prep
%setup -q -n importlib_metadata-4.5.0
cd %{_builddir}/importlib_metadata-4.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622817578
...
cp %{_builddir}/importlib_metadata-4.5.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
