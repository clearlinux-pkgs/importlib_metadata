...
Source0  : https://files.pythonhosted.org/packages/85/0e/faec12e1c81ac13394e7df7a578e3177a58bab80b6abce92bfa558cc210e/importlib_metadata-3.7.0.tar.gz
...
%prep
%setup -q -n importlib_metadata-3.7.0
cd %{_builddir}/importlib_metadata-3.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614267565
...
cp %{_builddir}/importlib_metadata-3.7.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
