...
Source0  : https://files.pythonhosted.org/packages/a0/d1/93d2dec161192f8ec90e9ef7fd31c26fe55d0226684e9dde35b1e2586def/importlib_metadata-3.10.1.tar.gz
...
%prep
%setup -q -n importlib_metadata-3.10.1
cd %{_builddir}/importlib_metadata-3.10.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618325427
...
cp %{_builddir}/importlib_metadata-3.10.1/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
