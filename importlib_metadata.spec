...
Source0  : https://files.pythonhosted.org/packages/e2/ae/0b037584024c1557e537d25482c306cf6327b5a09b6c4b893579292c1c38/importlib_metadata-1.7.0.tar.gz
...
%prep
%setup -q -n importlib_metadata-1.7.0
cd %{_builddir}/importlib_metadata-1.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593466511
...
cp %{_builddir}/importlib_metadata-1.7.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
