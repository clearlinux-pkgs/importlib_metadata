...
Source0  : https://files.pythonhosted.org/packages/30/8c/aafe43247cd18441740a4c3976c29b147e9df3ce79c1076b4e4f6253d15d/importlib_metadata-3.3.0.tar.gz
...
%prep
%setup -q -n importlib_metadata-3.3.0
cd %{_builddir}/importlib_metadata-3.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607962849
...
cp %{_builddir}/importlib_metadata-3.3.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
