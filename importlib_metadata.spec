...
Source0  : https://files.pythonhosted.org/packages/8c/0e/10e247f40c89ba72b7f2a2104ccf1b65de18f79562ffe11bfb837b711acf/importlib_metadata-1.4.0.tar.gz
...
%prep
%setup -q -n importlib_metadata-1.4.0
cd %{_builddir}/importlib_metadata-1.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578930852
...
cp %{_builddir}/importlib_metadata-1.4.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
