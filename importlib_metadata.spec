...
Source0  : https://files.pythonhosted.org/packages/d7/cd/3b1dffa46b19dac269d586b9d45090588a8bd7a5741602a369d45e1bdf65/importlib_metadata-1.5.2.tar.gz
...
%prep
%setup -q -n importlib_metadata-1.5.2
cd %{_builddir}/importlib_metadata-1.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585266285
...
cp %{_builddir}/importlib_metadata-1.5.2/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
