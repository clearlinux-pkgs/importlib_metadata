...
%prep
%setup -q -n importlib_metadata-4.0.1
cd %{_builddir}/importlib_metadata-4.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619023458
...
cp %{_builddir}/importlib_metadata-4.0.1/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
