...
Source0  : https://files.pythonhosted.org/packages/56/1f/74c3e29389d34feea2d62ba3de1169efea2566eb22e9546d379756860525/importlib_metadata-2.0.0.tar.gz
...
%prep
%setup -q -n importlib_metadata-2.0.0
cd %{_builddir}/importlib_metadata-2.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600882126
...
cp %{_builddir}/importlib_metadata-2.0.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
