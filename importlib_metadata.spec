...
Source0  : https://files.pythonhosted.org/packages/0e/75/92eed8e2ae8cd78f03c8ab9faf26e561482f3453a6f271a81e792178dd54/importlib_metadata-4.6.0.tar.gz
...
%prep
%setup -q -n importlib_metadata-4.6.0
cd %{_builddir}/importlib_metadata-4.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624892052
...
cp %{_builddir}/importlib_metadata-4.6.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
