...
Source0  : https://files.pythonhosted.org/packages/0d/d3/eaf93bb0efa8032bbff23fffd80beecbd74a49051874b9918dff5cd48f4c/importlib_metadata-3.6.0.tar.gz
...
%prep
%setup -q -n importlib_metadata-3.6.0
cd %{_builddir}/importlib_metadata-3.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614180016
...
cp %{_builddir}/importlib_metadata-3.6.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
