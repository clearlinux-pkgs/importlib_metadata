...
Source0  : https://files.pythonhosted.org/packages/22/1a/7898a186c81c69b81a4e065065671431c40f34ab801c3e0c4e840b1a7010/importlib_metadata-4.3.0.tar.gz
...
%prep
%setup -q -n importlib_metadata-4.3.0
cd %{_builddir}/importlib_metadata-4.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622125730
...
cp %{_builddir}/importlib_metadata-4.3.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
