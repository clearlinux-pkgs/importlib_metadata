...
Source0  : https://files.pythonhosted.org/packages/9a/5a/5bee793e43f6499b7e28de7c0333f49752590826b08a456f3874f555f4f5/importlib_metadata-4.0.0.tar.gz
...
%prep
%setup -q -n importlib_metadata-4.0.0
cd %{_builddir}/importlib_metadata-4.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618778094
...
cp %{_builddir}/importlib_metadata-4.0.0/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
