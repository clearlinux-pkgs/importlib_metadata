...
Source0  : https://files.pythonhosted.org/packages/3f/a8/16dc098b0addd1c20719c18a86e985be851b3ec1e103e703297169bb22cc/importlib_metadata-3.1.1.tar.gz
...
%prep
%setup -q -n importlib_metadata-3.1.1
cd %{_builddir}/importlib_metadata-3.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606924844
...
cp %{_builddir}/importlib_metadata-3.1.1/LICENSE %{buildroot}/usr/share/package-licenses/importlib_metadata/da4dc954bbc3ab0893517cb1d7af5598f7a3daf4
